...
values(1001,'���','captain','���Ӱ���',550,to_date('1990-06-23','YYYY-MM-DD'),100,101,'captain@abc.net','http://www.abc.net');

insert into professor
values(1002,'����','sweety','������',380,to_date('1997-01-30','YYYY-MM-DD'),60,101,'sweety@abc.net','http://www.abc.net');

insert into professor
values (1003,'���ڹ�','powerman','���Ӱ���',270,to_date('2008-03-22','YYYY-MM-DD'),null,101,'pman@power.com','http://www.power.com');

insert into professor
values (2011,'��ȣ��','lamb1','���Ӱ���',250,to_date('2011-09-01','YYYY-MM-DD'),null,102,'lamb1@hamail.net',null);

insert into professor
values (2012,'������','number1','������',350,to_date('1995-11-30','YYYY-MM-DD'),80,102,'number1@naver.com','http://num1.naver.com');

insert into professor
values (2013,'��â��','bluedragon','������',490,to_date('1992-04-29','YYYY-MM-DD'),90,102,'bdragon@naver.com',null);

insert into professor
values (3001,'�赵��','angel1004','������',530,to_date('1991-10-23','YYYY-MM-DD'),110,103,'angel1004@hanmir.com',null);

insert into professor
values (3002,'���ѿ�','naone10','������',330,to_date('2007-07-01','YYYY-MM-DD'),50,103,'naone10@empal.com',null);

insert into professor
values (3003,'������','only-u','���Ӱ���',290,to_date('2012-02-24','YYYY-MM-DD'),null,103,'only_u@abc.com',null);

insert into professor
values (4001,'�ɽ�','simson','������',570,to_date('1991-10-23','YYYY-MM-DD'),130,201,'chebin@daum.net',null);

insert into professor
values (4002,'�ֽ���','gogogo','������',330,to_date('2019-08-30','YYYY-MM-DD'),null,201,'gogogo@def.com',null);

insert into professor
values (4003,'������','mypride','������',310,to_date('2009-12-01','YYYY-MM-DD'),50,202,'mypride@hanmail.net',null);

insert into professor
values (4004,'������','ironman','���Ӱ���',260,to_date('2019-01-28','YYYY-MM-DD'),null,202,'ironman@naver.com',null);

insert into professor
values (4005,'�ٺ�','standkang','������',500,to_date('1995-09-18','YYYY-MM-DD'),80,203,'standkang@naver.com',null);

insert into professor 
values (4006,'��','napeople','���Ӱ���',220,to_date('2010-06-28','YYYY-MM-DD'),null,301,'napeople@jass.com',null);

insert into professor
values (4007,'������','silver-her','������',290,to_date('2011-05-23','YYYY-MM-DD'),30,301,'silver-her@daum.net',null);
...
9411,'ȫ�浿','75true',4,'7510231901813',to_date('1975-10-23','YYYY-MM-DD'),'055)381-2158',180,72,101,201,1001);

insert into student values (
9412,'�̻��','pooh94',4,'7502241128467',to_date('1975-02-24','YYYY-MM-DD'),'051)426-1700',172,64,102,null,2011);

insert into student values (
9413,'������','angel000',4,'7506152123648',to_date('1975-06-15','YYYY-MM-DD'),'053)266-8947',168,52,103,203,3002);

insert into student values (
9414,'���л�','gunmandu',4,'7512251063421',to_date('1975-12-25','YYYY-MM-DD'),'02)6255-9875',177,83,201,null,4001);

insert into student values (
9415,'������','pincle1',4,'7503031639826',to_date('1975-03-03','YYYY-MM-DD'),'031)740-6388',182,70,202,null,4003);

insert into student values (
9511,'�̼���','bingo',3,'7601232186327',to_date('1976-01-23','YYYY-MM-DD'),'055)333-6328',164,48,101,null,1002);

insert into student values (
9512,'������','jjang1',3,'7604122298371',to_date('1976-04-12','YYYY-MM-DD'),'051)418-9627',161,42,102,201,2012);
...
insert into student values (
9515,'�����','shyun1',3,'7610122196482',to_date('1976-10-12','YYYY-MM-DD'),'02)312-9838',171,54,201,null,4001);

insert into student values (
9611,'������','onejimae',2,'7711291186223',to_date('1977-11-29','YYYY-MM-DD'),'02)6788-4861',182,72,101,null,1002);

insert into student values (
9612,'������','samjang7',2,'7704021358674',to_date('1977-04-02','YYYY-MM-DD'),'055)488-2998',171,70,102,null,2011);
...
insert into student values (
9714,'������','kimjh',1,'7803241991997',to_date('1978-03-24','YYYY-MM-DD'),'055)423-9870',179,81,102,null,null);
...
INSERT INTO EMP2 VALUES (20000101,'������',TO_DATE('19640125','YYYYMMDD'),'0001','������','054)223-0001','���ǰ���',100000000,'��ǥ�̻�',null);
INSERT INTO EMP2 VALUES (20060101,'������',TO_DATE('19730322','YYYYMMDD'),'1000','������','02)6255-8000','����',72010000,'����',20000101);
INSERT INTO EMP2 VALUES (20070201,'���ϵ�',TO_DATE('19750415','YYYYMMDD'),'1000','������','02)6255-8005','�',50000000,'����',20060101);
INSERT INTO EMP2 VALUES (20030331,'�����',TO_DATE('19760525','YYYYMMDD'),'1001','������','02)6255-8010','������Ÿ��',60000000,'����',20060101);
INSERT INTO EMP2 VALUES (20050303,'õ����',TO_DATE('19730615','YYYYMMDD'),'1002','������','02)6255-8020','������',56000000,'����',20060101);
INSERT INTO EMP2 VALUES (20066102,'������',TO_DATE('19720705','YYYYMMDD'),'1003','������','052)223-4000','���ǰ���',75000000,'����',20000101);
INSERT INTO EMP2 VALUES (20030402,'������',TO_DATE('19720815','YYYYMMDD'),'1004','������','042)998-7005','���',51000000,'����',20066102);
INSERT INTO EMP2 VALUES (20060303,'�蹮ȣ',TO_DATE('19710925','YYYYMMDD'),'1005','������','031)564-3340','���',35000000,'�븮',20066102);
INSERT INTO EMP2 VALUES (20070112,'����ȣ',TO_DATE('19761105','YYYYMMDD'),'1006','������','054)223-4500','����',68000000,'����',20000101);
INSERT INTO EMP2 VALUES (20060212,'������',TO_DATE('19721215','YYYYMMDD'),'1007','������','054)223-4600',null,49000000,'����',20070112);
INSERT INTO EMP2 VALUES (20100101,'���¹�',TO_DATE('19950125','YYYYMMDD'),'1008','�����','051)123-4567','���', 30000000,'',20060212);
INSERT INTO EMP2 VALUES (20100102,'�輳��',TO_DATE('19930322','YYYYMMDD'),'1009','�����','031)234-5678','����', 30000000,'',20060212);
INSERT INTO EMP2 VALUES (20100203,'�ֿ���',TO_DATE('19920415','YYYYMMDD'),'1010','�����','02)2345-6789','�ٵ�', 30000000,'',20060212);
INSERT INTO EMP2 VALUES (20100334,'������',TO_DATE('19910525','YYYYMMDD'),'1011','�����','053)456-7890','�뷡', 30000000,'',20060212);
INSERT INTO EMP2 VALUES (20100305,'���Ͼ�',TO_DATE('19900615','YYYYMMDD'),'1008','������','051)567-8901','����', 22010000,'',20060212);
INSERT INTO EMP2 VALUES (20106106,'������',TO_DATE('19900705','YYYYMMDD'),'1009','������','031)678-9012','��',   22010000,'',20060212);
INSERT INTO EMP2 VALUES (20100407,'���ֿ�',TO_DATE('19900815','YYYYMMDD'),'1010','������','02)2789-0123','����', 22010000,'',20060212);
INSERT INTO EMP2 VALUES (20100308,'������',TO_DATE('19900925','YYYYMMDD'),'1011','������','053)890-1234','����', 20100000,'',20060212);
INSERT INTO EMP2 VALUES (20100119,'��ݰ�',TO_DATE('19901105','YYYYMMDD'),'1004','������','042)901-2345','��',   20100000,'',20030402);
INSERT INTO EMP2 VALUES (20100210,'���Ѷ�',TO_DATE('19901215','YYYYMMDD'),'1005','������','031)345-3456','����', 20100000,'',20060303);
COMMIT;
...
insert into gift values(2,'��Ǫ��Ʈ',100001,201000);
insert into gift values(3,'������ǰ��Ʈ',201001,300000);
...
insert into gogak values (20110001,'������','7510231369824',980000);
insert into gogak values (20110002,'�����','7502241128467',73000);
insert into gogak values (20110003,'�̹̰�','7506152123648',320100);
insert into gogak values (20110004,'�����','7512251063421',65000);
insert into gogak values (20110005,'�ڵ�ȣ','7503031639826',180000);
insert into gogak values (20110006,'��ſ�','7601232186327',153000);
insert into gogak values (20110007,'������','7604212298371',273000);
insert into gogak values (20110008,'������','7609112118379',315000);
insert into gogak values (20110009,'�輳��','7601202378641',542010);
insert into gogak values (20110010,'�Ӽ���','7610122196482',265000);
insert into gogak values (20110011,'�ּ���','7711291186223',110000);
insert into gogak values (20110012,'������','7704021358674',99000);
insert into gogak values (20110013,'�ȱ���','7709131276431',470000);
insert into gogak values (20110014,'��ȯ','7702261196365',298000);
insert into gogak values (20110015,'����ȣ','7712141254963',420100);
insert into gogak values (20110016,'������','7808192157498',598000);
insert into gogak values (20110017,'������','7801051776346',625000);
insert into gogak values (20110018,'�ο���','7808091786954',670000);
insert into gogak values (20110019,'������','7803242114563',770000);
insert into gogak values (20110020,'���','7802232116784',730000);
commit ;
...
insert into p_grade values ('����',0,24,1,2,12010000,29990000);
...
insert into panmae values ('20110101',102,2,2010,'1003');
insert into panmae values ('20110101',103,6,5400,'1004');
insert into panmae values ('20110102',102,2,2010,'1000');
...
insert into panmae values ('20110104',100,4,3201,'1003');
...
insert into panmae values ('20110104',102,2,2010,'1002');

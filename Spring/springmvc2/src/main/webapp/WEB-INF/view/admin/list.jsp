...
<style>
  ...
  <tr><th>아이디<a href="list?sort=1" class="noline">▲</a><%--ㅁ한자 --%>
              <a href="list?sort=2" class="noline">▼</a></th>
  <th>이름<a href="list?sort=3" class="noline">▲</a><%--ㅁ한자 --%>
         <a href="list?sort=4" class="noline">▼</a></th>
  <th>전화</th><th>생일</th>
  <th>이메일<a href="list?sort=5" class="noline">▲</a><%--ㅁ한자 --%>
         <a href="list?sort=6" class="noline">▼</a>
  </th><th>&nbsp;</th></tr>
